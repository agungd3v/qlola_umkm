    ...
    return FutureBuilder(
      ...
      builder: (context, snapshot) {
        ...
        if (snapshot.data != null) {
          if (snapshot.data["transaction_count_month"] < 1) {
            return Expanded(
              child: Container(
          ...
          return SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                for (var index = 0; index < snapshot.data["transaction_count_month"]; index++) TransactionItem(
                  transaction: snapshot.data["monthly_transactions"][index]
                ),
                const SizedBox(height: 6)
              ]
            )
