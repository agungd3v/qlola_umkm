                    ...
                    child: Column(
                      ...
                      Text("Transaksi",
                          style: TextStyle(
                              ...
                              fontSize:
                                  18)), // Same font size as "Transaksi" in OrderItem
                      Text("Riwayat transaksi kamu hari ini.",
                          style: TextStyle(
                              fontFamily: "Poppins",
                              color: Theme.of(context).disabledColor,
                              fontSize: 14)) // Adjusted size for the subheading
                    ]))
              ])),
          Expanded(
              child: LayoutBuilder(
                                                  ...
                                                  child: Text(
                                                      ...
                                                      style: TextStyle(
                                                          ...
                                                          color: Theme.of(
                                                              ...
                                                              .primaryColorDark,
                                                          fontSize:
                                                              14))) // Adjusted size for the message
                                            ])
                                          ])
                                  ])))))))
        ]));
